...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-gray-500">Seleccioná un médico para ver sus informes</p>
        </div>
    </div>
        ...
        <table class="w-full text-left">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr class="text-gray-500 text-[10px] uppercase font-bold">
                    ...
                    <th class="px-6 py-3 text-center">Resumen por Mes</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-xs text-center">
                        <a href="{{ route('rrhh.medicos.resumen', $medico->id) }}"
                           class="bg-brandSecundario hover:opacity-90 text-white px-4 py-2 rounded-lg text-xs font-bold transition shadow inline-block">
                            <i class="fas fa-chart-bar mr-1.5"></i> Ver Resumen
                        </a>
                    </td>
                </tr>
                @empty
